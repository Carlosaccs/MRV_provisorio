...
    if (selecionado.tipo === 'R') {
        // CORREÇÃO: Removido o "RES." que era adicionado antes do nome
        html += `<div class="titulo-vitrine-faixa faixa-laranja">${selecionado.nome.toUpperCase()} — ${selecionado.regiao}</div>`;
        html += `
